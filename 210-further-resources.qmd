...
- [SimDesign](https://github.com/philchalmers/SimDesign/wiki) R package (Chalmers, 2019)
    ...
    - [Chalmers & Adkin (2019)](http://www.tqmp.org/RegularArticles/vol16-4/p248/). Writing effective and reliable Monte Carlo\index{Monte Carlo simulation} simulations with the SimDesign package.
