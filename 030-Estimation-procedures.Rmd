...
Next, we describe strategies for validating the coded-up estimator before running a full simulation in Section \@ref(validating-estimation-function).
...
<!-- LWM: I think we don't need anything? -->
...
M1
```
We then pick apart the pieces and make a dataframe of them:
...
```
Now we can plug the above code to make a nicely quieted and safe function.
