...
<!-- LWM: I don't think it is needed.  The aggregation code below could be framed as such.  I added some text. -->
...
<!--To flag another common pitfall, R likes to recycle vectors to make them the right length; if you gave it a wrong length by mistake, finding out can be brutally difficult to discover.-->
...
<!-- LWM: It looks like you retooled the code considerably.  This was a check to make sure you did not have both tx and co units in all schools, originally.  Text updated. -->
