...
That warning made, in the next sections we will look at a few optimization efforts applied to the ANOVA example from Section @sec-case-ANOVA to illustrate some principles of optimization that come up a lot in simulation projects.

### Hand-building functions
In our initial ANOVA simulation (see Chapter @sec-case-ANOVA) we used the system-implemented ANOVA.\index{example!heteroskedastic ANOVA (Welch)}
...
We are using data as generated in Chapter @sec-data-generating-processes.
...
### Computational efficiency versus simplicity {#sec-sec_comp_efficiency}
