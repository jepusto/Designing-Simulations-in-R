...
<!-- LWM: I think it is good.  Why do you want to add? -->
...
We _do not_ model the predictors themselves.
...
In particular, writing data-generating functions is a very effective way to _study_ a statistical model, such as a model that you might be learning about in a course or through self-study.
...
<!-- LWM: What does this "make the model simplify" mean? -->
