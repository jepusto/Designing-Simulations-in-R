...
# Data-Generating Processes (DGPs) {#chap_DGP}
...
3. Once you are satisfied you have a correct DGP function, re-run the Type-I error rate calculations from [the prior exercises](#exAnovaExercises) on page @exAnovaExercises using a $t$-distribution with 5 degrees of freedom.
