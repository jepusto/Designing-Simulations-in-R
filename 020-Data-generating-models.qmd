...
3. Once you are satisfied that you have a correct DGP function, re-run the Type-I error rate calculations from the prior exercises in @sec-exAnovaExercises using a $t$-distribution with 5 degrees of freedom.
