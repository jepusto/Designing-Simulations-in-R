...
```{r}
#| label: fig-biserial-N
#| code-fold: true
#| echo: !expr knitr::is_html_output()
#| fig-width: 10
#| fig-height: 5
#| fig-cap: "Bias of the biserial correlation estimate in an extreme groups design as a function of inverse sample size, cut-off thresholds, and cut-off types, for selected values of $\\rho$."
...
```{r}
#| label: fig-biserial-beta-summary-2
#| code-fold: true
#| echo: !expr knitr::is_html_output()
#| fig-width: 7
#| fig-height: 3
