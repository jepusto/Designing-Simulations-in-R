...
We do not dive deeply into validity or power; see Chapter @sec-power for more on those measures.
...
We can instead try using the degree of freedom calculations we saw in Section @sec-performance-stability.
