...
```{r author-circle, fig.width = 2.5, fig.height = 2.5, out.width = "33%", echo=FALSE}
...
But anyway, more about us.

<!-- LWM: Change your intro to more expanded and in first person?  I have a note from you that says 'Read Singer and Willet intro (rec James P) for model of author statement' -- I need to do that still. -->
...
<<<<<<< Updated upstream
Some parts of this book are based on memos or other writings generated for various purposes.
Some of these parts were initially written by or co-written with others; we have attributed these as they arise.

=======
Some parts of this book are based on memos or other writings generated for various purposes. Some of this was written by others.
