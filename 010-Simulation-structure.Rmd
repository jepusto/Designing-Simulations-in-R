...
Table: Steps in the Simulation Process {#tbl:simulation}
...
As we saw in our initial example, we can break the the logic of simulation for a specific and specified scenario down into the four steps outlined on Table @tbl:simulation.
...
In particular, we write separate functions for each of the steps given in Table @tbl:simulation.
...
We will discuss multiple-scenario simulations in Part III (starting with Chapter @exp_design), after we more fully develop the core concepts listed above.
