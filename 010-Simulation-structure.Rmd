...
results <- map_df(1:R, \(x) one_run( params ))
...
results <- map_dfr(1:R, \(x) one_run( params ))
```
...
In the second argument, we specify a function that evaluates `one_run()` for specified values of the model parameters stored in `params`.
