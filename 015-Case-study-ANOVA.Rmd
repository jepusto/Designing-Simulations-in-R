...
<!-- LWM: I made the above paragraph not a footnote since I thought it deserved more light.  Put back if desired. -->
...
Given some parameters, `generate_data` produces a simulated dataset and, given some data, `ANOVA_Welch_F`  calculates $p$-values two different ways.
...
Try simulating the **power levels** for a couple of sets of parameter values from Table \@ref(tab:BF_power). Use 10,000 replications. How do your results compare to the results reported in the Table?
