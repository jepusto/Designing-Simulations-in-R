...
In fact, if we use the same seed, we should obtain _exactly_ the same results.
...
<!-- JEP: Perhaps a little bit more context here, to remind readers of the problem set-up if it has been a while since they read chapter 6? -->
