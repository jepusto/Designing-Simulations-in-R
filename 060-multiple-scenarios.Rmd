...
For a single factor simulation, making our schedule of simulations to run is easy. This step will get more involved with multi-factor simulations, as described in Section \@ref(simulating-across-multiple-factors).
...
The following code runs the same experiment as in Section \@ref(using-pmap-to-run-multifactor-simulations), but stores the individual replications:
