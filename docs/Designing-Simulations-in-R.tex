...
##      n1    n2 mean_diff     K rej_rate rej_rate_~1
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-83-1} \end{center}
...
##        n     p alpha    df crite~1     est    MCSE
##    <dbl> <dbl> <dbl> <dbl> <chr>     <dbl>   <dbl>
##  1    50     4   0.1     5 alpha ~ -0.103  1.67e-2
##  2    50     4   0.1     5 alpha ~  0.388  1.56e-3
##  3    50     4   0.1     5 V rela~  0.436  3.38e-3
##  4    50     4   0.1     5 covera~  0.826  9.75e-3
##  5    50     4   0.1    10 alpha ~ -0.0527 1.15e-2
##  6    50     4   0.1    10 alpha ~  0.263  4.88e-4
##  7    50     4   0.1    10 V rela~  0.780  2.45e-3
##  8    50     4   0.1    10 covera~  0.908  9.75e-3
##  9    50     4   0.1    20 alpha ~ -0.0190 9.84e-3
## 10    50     4   0.1    20 alpha ~  0.221  4.68e-4
## # ... with 566 more rows, and abbreviated
## #   variable name 1: criterion
## # i Use `print(n = ...)` to see more rows
\end{verbatim}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-124-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-144-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-145-1} \end{center}
...
##  Rfunction 505.072 517.3130 590.4735 523.0385
##     direct 231.375 238.6925 260.6193 243.2120
##        uq      max neval cld
##  596.7095 3398.902   100   b
##  268.0585  715.640   100  a
\end{verbatim}
...
## Unit: milliseconds
##   expr      min       lq     mean   median
##  noagg 1.442335 1.498732 1.956876 1.571045
##    agg 3.961735 4.250489 4.771251 4.489663
##        uq      max neval cld
##  1.727870 23.15160   100  a 
##  4.895858 13.05169   100   b
\end{verbatim}
...
\hypertarget{the-data-generating-process-1}{%
...
## 1  1 1 0.06881051 0.10758281 0.06382513
## 2  2 1 0.10945911 0.03779567 0.05328905
## 3  3 1 0.01649212 0.03527745 0.01868862
## 4  4 0 0.14944083 0.12577203 0.09451428
##   pdisc_2018  pdisc_2019
## 1 0.02737314 0.012127238
## 2 0.03669081 0.022538540
## 3 0.00256124 0.002767943
## 4 0.04844326 0.022815571
\end{verbatim}
...
\begin{verbatim}
## # A tibble: 7 x 5
##   model         estimate std.error stati~1 p.value
##   <chr>            <dbl>     <dbl>   <dbl>   <dbl>
## 1 FE            -0.525     0.326   -1.61     0.119
## 2 log            0.208     0.229    0.909    0.430
## 3 log_twopost   -0.0673    0.291   -0.232    0.832
## 4 ratio         -0.00850   0.119   -0.0714   0.945
## 5 ratio_twopost -0.203     0.141   -1.44     0.201
## 6 raw            0.106     0.163    0.652    0.539
## 7 simple         0.00730   0.00625  1.17     0.327
## # ... with abbreviated variable name 1: statistic
\end{verbatim}

We have a nice set of estimates, one for each model.

\hypertarget{running-the-simulation-1}{%
...
##      n_c   n_t    tx model    E_est     SE E_SE_~1
##    <dbl> <dbl> <dbl> <chr>    <dbl>  <dbl>   <dbl>
##  1     4     4  0.5  FE     -0.693  0.313   0.277 
##  2     4     4  0.5  log    -0.694  0.476   0.430 
##  3     4     4  0.5  log_t~ -0.692  0.431   0.383 
##  4     4     4  0.5  ratio  -0.374  0.219   0.203 
##  5     4     4  0.5  ratio~ -0.291  0.151   0.139 
##  6     4     4  0.5  raw    -0.719  0.535   0.515 
##  7     4     4  0.5  simple -0.0195 0.0194  0.0157
##  8     4     4  0.75 FE     -0.292  0.310   0.274 
##  9     4     4  0.75 log    -0.295  0.488   0.435 
## 10     4     4  0.75 log_t~ -0.305  0.424   0.373 
## # ... with 368 more rows, 1 more variable:
## #   pow <dbl>, and abbreviated variable name
## #   1: E_SE_hat
## # i Use `print(n = ...)` to see more rows, and `colnames()` to see all variable names
\end{verbatim}

\hypertarget{evaluating-power}{%
...
\hypertarget{checking-validity-of-our-models}{%
...
\hypertarget{assessing-precision-se}{%
...
\hypertarget{assessing-minimum-detectable-effects}{%
...
\begin{verbatim}
## # A tibble: 1 x 6
##   bias.hat var.hat CIlog_~1 CIlog~2 CI_low CI_high
##      <dbl>   <dbl>    <dbl>   <dbl>  <dbl>   <dbl>
## 1  -0.0420  0.0856     4.07    5.21   58.4    184.
## # ... with abbreviated variable names
## #   1: CIlog_low, 2: CIlog_high
\end{verbatim}
...
\begin{verbatim}
## # A tibble: 2 x 8
##   method    bias.~1 var.hat CIlog~2 CIlog~3 CI_low
##   <chr>       <dbl>   <dbl>   <dbl>   <dbl>  <dbl>
## 1 parametr~ -0.0420  0.0856    4.07    5.21   58.4
## 2 casewise  -0.0651  0.132     3.90    5.33   49.6
## # ... with 2 more variables: CI_high <dbl>,
## #   length <dbl>, and abbreviated variable names
## #   1: bias.hat, 2: CIlog_low, 3: CIlog_high
