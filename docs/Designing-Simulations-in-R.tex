...
\hypertarget{a-mathematical-model-is-a-recipe-for-data-generation}{%
\subsection{A mathematical model is a recipe for data generation}\label{a-mathematical-model-is-a-recipe-for-data-generation}}
...
\subsection{A statistical model is a recipe for data generation}\label{a-statistical-model-is-a-recipe-for-data-generation}}
...
\hypertarget{example-on-cluster-rct}{%
\subsection{Example on Cluster RCT}\label{example-on-cluster-rct}}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-88-1} \end{center}
...
##  Rfunction 508.472 522.3480 585.8018 527.904 563.5140 3466.067   100
##     direct 230.265 239.0515 258.5928 243.270 260.3965  529.930   100
\end{verbatim}
...
## Unit: milliseconds
##   expr      min       lq     mean   median       uq      max neval
##  noagg 1.429614 1.472500 2.072491 1.560123 1.731267 26.48571   100
##    agg 3.937440 4.228604 4.908075 4.396332 4.765747 11.83880   100
\end{verbatim}
