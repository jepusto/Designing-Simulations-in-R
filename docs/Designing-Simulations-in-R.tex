...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-48-1} \end{center}
...
\hypertarget{example-the-clustered-rct}{%
\section{Example: The Clustered RCT}\label{example-the-clustered-rct}}
...
##  1    50     4   0.1     5        500 <df [4 x 3]>
##  2   100     4   0.1     5        500 <df [4 x 3]>
##  3    50     8   0.1     5        500 <df [4 x 3]>
##  4   100     8   0.1     5        500 <df [4 x 3]>
##  5    50     4   0.2     5        500 <df [4 x 3]>
##  6   100     4   0.2     5        500 <df [4 x 3]>
##  7    50     8   0.2     5        500 <df [4 x 3]>
##  8   100     8   0.2     5        500 <df [4 x 3]>
##  9    50     4   0.3     5        500 <df [4 x 3]>
## 10   100     4   0.3     5        500 <df [4 x 3]>
## # ... with 134 more rows
\end{verbatim}
...
##  1    50     4   0.1     5 alpha bias      -0.0671
##  2    50     4   0.1     5 alpha RMSE       0.309 
##  3    50     4   0.1     5 V relative bias  0.601 
##  4    50     4   0.1     5 coverage         0.854 
##  5   100     4   0.1     5 alpha bias      -0.0469
##  6   100     4   0.1     5 alpha RMSE       0.239 
##  7   100     4   0.1     5 V relative bias  0.462 
##  8   100     4   0.1     5 coverage         0.804 
##  9    50     8   0.1     5 alpha bias      -0.0781
## 10    50     8   0.1     5 alpha RMSE       0.357 
...
After the \texttt{pmap()} call, we would end up with a dataframe with all our simulations, one simulation context per row (or maybe bundles, one for each method), with
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{saveRDS}\NormalTok{( sim\_results\_full, }\StringTok{"results/cronbach\_results\_full.rds"}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{file.size}\NormalTok{(}\StringTok{"results/cronbach\_results.rds"}\NormalTok{) }\SpecialCharTok{/} \DecValTok{1024}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{file.size}\NormalTok{(}\StringTok{"results/cronbach\_results\_full.rds"}\NormalTok{) }\SpecialCharTok{/} \DecValTok{1024}
\end{Highlighting}
\end{Shaded}
...
##  1    50     4   0.1     5          [500 x 4]
##  2    50     4   0.1    10          [500 x 4]
##  3    50     4   0.1    20          [500 x 4]
##  4    50     4   0.1   100          [500 x 4]
##  5    50     4   0.2     5          [500 x 4]
##  6    50     4   0.2    10          [500 x 4]
##  7    50     4   0.2    20          [500 x 4]
##  8    50     4   0.2   100          [500 x 4]
##  9    50     4   0.3     5          [500 x 4]
## 10    50     4   0.3    10          [500 x 4]
## # ... with 134 more rows
\end{verbatim}
...
##        n     p alpha    df criterion           est
##    <dbl> <dbl> <dbl> <dbl> <chr>             <dbl>
##  1    50     4   0.1     5 alpha bias      -0.0798
##  2    50     4   0.1     5 alpha RMSE       0.328 
##  3    50     4   0.1     5 V relative bias  0.557 
##  4    50     4   0.1     5 coverage         0.82  
##  5    50     4   0.1    10 alpha bias      -0.0384
##  6    50     4   0.1    10 alpha RMSE       0.280 
##  7    50     4   0.1    10 V relative bias  0.661 
##  8    50     4   0.1    10 coverage         0.892 
##  9    50     4   0.1    20 alpha bias      -0.0390
## 10    50     4   0.1    20 alpha RMSE       0.229 
## # ... with 566 more rows, and 1 more variable:
## #   MCSE <dbl>
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{( }\AttributeTok{file =} \StringTok{"results/simulation\_CRT.csv"}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Rows: 202500 Columns: 14
## -- Column specification --------------------------
## Delimiter: ","
## chr  (1): method
## dbl (13): n_bar, J, ATE, size_coef, ICC, alpha...
## 
...
\begin{verbatim}
##     E.tau.hat  E.SE.hat  power nC nT sdC tau mu
## 1 0.002128220 0.8778090 0.1955  2  2   1 0.0  5
## 2 0.004213967 0.9485353 0.1900  2  2   1 0.0  5
## 3 0.479656622 0.8882619 0.2200  2  2   1 0.5  5
## 4 0.504158009 0.9203311 0.2270  2  2   1 0.5  5
## 5 0.997660761 0.9048522 0.2970  2  2   1 1.0  5
## 6 1.011741501 0.9412058 0.3160  2  2   1 1.0  5
##   sdTau    R
## 1   0.0 2000
## 2   0.5 2000
## 3   0.0 2000
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-127-1} \end{center}
...
\hline
0 & 0.20 & 0.05 & 50 & 50 & 1 & 0 & 5 & 0.0 & 2000\\
\hline
0 & 0.21 & 0.05 & 50 & 50 & 1 & 0 & 5 & 0.5 & 2000\\
\hline
0 & 0.15 & 0.05 & 50 & 500 & 1 & 0 & 5 & 0.0 & 2000\\
\hline
0 & 0.15 & 0.06 & 50 & 500 & 1 & 0 & 5 & 0.5 & 2000\\
\hline
0 & 0.15 & 0.06 & 500 & 50 & 1 & 0 & 5 & 0.0 & 2000\\
\hline
0 & 0.16 & 0.06 & 500 & 50 & 1 & 0 & 5 & 0.5 & 2000\\
\hline
0 & 0.06 & 0.05 & 500 & 500 & 1 & 0 & 5 & 0.0 & 2000\\
\hline
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-147-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-148-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-150-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-153-1} \end{center}
...
##  Rfunction 575.966 607.309 729.8212 666.2045
##     direct 258.913 282.844 325.9848 304.8290
##        uq      max neval
##  757.7915 3678.385   100
##  340.9105  731.106   100
\end{verbatim}
...
## Unit: milliseconds
##   expr      min       lq     mean   median
##  noagg 1.611532 1.767286 2.709998 2.024473
##    agg 4.868906 5.621425 7.129655 6.491153
##        uq      max neval
##  2.542358 33.82564   100
##  7.796145 20.56839   100
\end{verbatim}
