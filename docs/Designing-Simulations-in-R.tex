...
\hypertarget{some-preliminaries}{%
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-26-1} \end{center}
...
##  Rfunction 646.0 708.10 778.294 738.30 779.9 2698.6   100
##     direct 276.1 309.45 374.012 326.35 348.9 4422.4   100
\end{verbatim}

The direct function is 2.1 times faster than the built-in R function.
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-49-1} \end{center}
...
## Unit: milliseconds
##   expr    min      lq     mean  median      uq     max neval
##  noagg 1.2605 1.36715 1.939356 1.45275 1.50035 34.7087   100
##    agg 4.2165 4.58690 5.126748 4.96025 5.24650 10.3768   100
\end{verbatim}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2418}}@{}}
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
Criterion
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-68-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-80-1} \end{center}
...
\NormalTok{alpha\_performance }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(alpha\_sims, alpha, }\AttributeTok{coverage\_level =}\NormalTok{ .}\DecValTok{95}\NormalTok{) \{}
  
  \CommentTok{\# setup}
\NormalTok{  K }\OtherTok{\textless{}{-}} \FunctionTok{nrow}\NormalTok{(alpha\_sims)}
\NormalTok{  A\_err }\OtherTok{\textless{}{-}}\NormalTok{ alpha\_sims}\SpecialCharTok{$}\NormalTok{A }\SpecialCharTok{{-}}\NormalTok{ alpha}
\NormalTok{  var\_A }\OtherTok{\textless{}{-}} \FunctionTok{var}\NormalTok{(alpha\_sims}\SpecialCharTok{$}\NormalTok{A)}
  
  \CommentTok{\# bias}
\NormalTok{  A\_bias }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(A\_err)}
\NormalTok{  A\_bias\_MCSE }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(var\_A }\SpecialCharTok{/}\NormalTok{ K)}
  
  \CommentTok{\# RMSE}
\NormalTok{  A\_RMSE }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{mean}\NormalTok{((A\_err)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{))}
\NormalTok{  RMSE\_j }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{((A\_RMSE}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ K }\SpecialCharTok{{-}}\NormalTok{ A\_err}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{) }\SpecialCharTok{/}\NormalTok{ (K }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{))}
\NormalTok{  A\_RMSE\_MCSE }\OtherTok{\textless{}{-}} \FunctionTok{sd}\NormalTok{(RMSE\_j)}
  
  \CommentTok{\# relative bias of variance estimator}
\NormalTok{  V\_bar }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(alpha\_sims}\SpecialCharTok{$}\NormalTok{Var\_A)}
\NormalTok{  V\_j }\OtherTok{\textless{}{-}}\NormalTok{ (V\_bar }\SpecialCharTok{*}\NormalTok{ K }\SpecialCharTok{{-}}\NormalTok{ alpha\_sims}\SpecialCharTok{$}\NormalTok{Var\_A) }\SpecialCharTok{/}\NormalTok{ (K }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)}
\NormalTok{  Ssq\_j }\OtherTok{\textless{}{-}}\NormalTok{ ((K }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{) }\SpecialCharTok{*}\NormalTok{ var\_A }\SpecialCharTok{{-}}\NormalTok{ A\_err}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ K }\SpecialCharTok{/}\NormalTok{ (K }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)) }\SpecialCharTok{/}\NormalTok{ (K }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{)}
\NormalTok{  RB\_j }\OtherTok{\textless{}{-}}\NormalTok{ V\_j }\SpecialCharTok{/}\NormalTok{ Ssq\_j}
\NormalTok{  V\_relbias }\OtherTok{\textless{}{-}}\NormalTok{ V\_bar }\SpecialCharTok{/}\NormalTok{ var\_A}
\NormalTok{  V\_relbias\_MCSE }\OtherTok{\textless{}{-}} \FunctionTok{sd}\NormalTok{(RB\_j)}
  
  \CommentTok{\# coverage}
\NormalTok{  coverage }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(alpha\_sims}\SpecialCharTok{$}\NormalTok{CI\_L }\SpecialCharTok{\textless{}}\NormalTok{ alpha }\SpecialCharTok{\&}\NormalTok{ alpha }\SpecialCharTok{\textless{}}\NormalTok{ alpha\_sims}\SpecialCharTok{$}\NormalTok{CI\_U)}
\NormalTok{  coverage\_MCSE }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(coverage\_level }\SpecialCharTok{*}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ coverage\_level) }\SpecialCharTok{/}\NormalTok{ K)}
  
  \FunctionTok{data.frame}\NormalTok{(}
    \AttributeTok{criterion =} \FunctionTok{c}\NormalTok{(}\StringTok{"alpha bias"}\NormalTok{,}\StringTok{"alpha RMSE"}\NormalTok{, }\StringTok{"V relative bias"}\NormalTok{, }\StringTok{"coverage"}\NormalTok{),}
    \AttributeTok{est =} \FunctionTok{c}\NormalTok{(A\_bias, A\_RMSE, V\_relbias, coverage),}
    \AttributeTok{MCSE =} \FunctionTok{c}\NormalTok{(A\_bias\_MCSE, A\_RMSE\_MCSE, V\_relbias\_MCSE, coverage\_MCSE)}
\NormalTok{  )}
\NormalTok{\}}

\CommentTok{\# Check performance calculations}
\FunctionTok{alpha\_performance}\NormalTok{(alpha\_sims, }\AttributeTok{alpha =} \FloatTok{0.73}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{runs }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(method) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{group\_modify}\NormalTok{(}
      \SpecialCharTok{\textasciitilde{}} \FunctionTok{calc\_absolute}\NormalTok{( ., }\AttributeTok{estimates =}\NormalTok{ ATE\_hat, }\AttributeTok{true\_param =}\NormalTok{ ATE,}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-117-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-120-1} \end{center}
