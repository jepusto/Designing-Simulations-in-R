...
Overall, aggregation and multilevel modeling have an RMSE that is around `r round(100 * abs(RMSE_ratio - 1))`% smaller than linear regression.
The greater precision is worth the bias price.
