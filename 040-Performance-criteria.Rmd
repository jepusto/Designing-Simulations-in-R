...
To do this we would need to modify our `gen_dat_model()` DGP code to track this additional information.
...
This is similar to directly calculating _potential outcomes_, as discussed in Chapter \@ref(chap-potential-outcomes).
