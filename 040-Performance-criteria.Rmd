...
Linear regression, with a bias of about 0.08 SDs, appears much more biased than the other estimators.
...
```
Our extremely precise estimate of the person-average effect is `r round( ATE_person, 3)`, which is consistent with what we would expect given the bias we saw earlier for the linear model.
