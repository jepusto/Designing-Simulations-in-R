...
\hypertarget{case-study-attrition-in-a-simple-randomized-experiment}{%
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/attrition-dag-1} \end{center}
...
\hypertarget{performance-criteria-1}{%
...
##   <chr>    <dbl>  <dbl>   <dbl>   <dbl>   <dbl>
## 1 MLM      -1.52   2.18   0.607       0       0
## 2 LR       -1.52   1.24   0.436       0       0
## 3 Agg      -1.52   1.24   0.436       0       0
\end{verbatim}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-118-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-126-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-146-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-149-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{Designing-Simulations-in-R_files/figure-latex/unnamed-chunk-152-1} \end{center}
...
##  Rfunction 523.785 533.7075 603.5160 545.6005
##     direct 234.456 242.9135 265.5523 248.6800
##        uq      max neval cld
##  594.8380 3347.723   100   b
##  272.0355  516.835   100  a
\end{verbatim}
...
## Unit: milliseconds
##   expr      min       lq     mean   median
##  noagg 1.487619 1.556523 1.924981 1.605843
##    agg 3.419803 3.697933 3.880711 3.789444
##        uq       max neval cld
##  1.677409 22.172271   100  a 
##  3.892687  8.565885   100   b
\end{verbatim}
...
\hypertarget{making-a-safe-function-call}{%
...
\hypertarget{what-to-do-with-warnings-in-simulations}{%
...
\hypertarget{the-data-generating-process-2}{%
...
## 5 ratio_twop~ -0.203     0.141     -1.44     0.201
