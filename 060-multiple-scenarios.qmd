...
In Section @sec-estimation-functions, we developed a function called `r_and_z()` for computing confidence intervals for Pearson's correlation using Fisher's $z$ transformation, and in Section @sec-evaluate-CIs, we wrote a function called `evaluate_CIs()` for evaluating confidence interval coverage and average width. 
