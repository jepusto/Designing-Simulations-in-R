...
The results are also organized in a way that facilitates visualization of the power levels, as in @fig-hetero-ANOVA-power.
...
```{r}
#| label: fig-hetero-ANOVA-power
#| code-fold: true
#| echo: !expr knitr::is_html_output()
#| fig-width: 7
#| fig-height: 3.5
#| fig-cap: "Power of the ANOVA-F test and Welch's F test as a function of the maximum mean difference between categories, for $\\alpha$ levels of .01 and .05."
