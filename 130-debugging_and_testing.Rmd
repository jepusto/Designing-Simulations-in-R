...
## Protecting functions with `stop()` {#about-stopifnot}
...
The `testthat` package is designed to allow for including unit testing in an R package, but we are repurposing it for general projects here.
