...
Our figure does have what appears to be a negative bias trend for `alpha = 0.5` and higher `ICC`---we expect this is Monte Carlo error, as we do not have a theoretical reason to expect bias here; simulations will often have unfortunate, and misleading, patterns that are driven by random chance.
